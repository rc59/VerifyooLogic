...
//	 DBObject query = BasicDBObjectBuilder.start().add("Name",
//	 userName).get();
...
//	
//	 template.Id = ((ObjectId) mongoTemplate.get("_id")).toString();
...
//	
//	 gesture.Id = ((ObjectId) mongoTemplate.get("_id")).toString();
...
//	
//	 stroke.Id = ((ObjectId) mongoTemplate.get("_id")).toString();
...
//	
//	 event.Id = ((ObjectId) mongoTemplate.get("_id")).toString();
