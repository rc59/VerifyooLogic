...
//	}
//	
//	public double TestFalseNegativeAndPositive(String name) {
//		Template tempTemplate = GetFromDB(name);				
//		
//		ArrayList<Gesture> tempListBase = new ArrayList<>();
//		ArrayList<Gesture> tempListAuth = new ArrayList<>();
//		
//		int count = 0;
//		for(int idx = 0; idx < tempTemplate.ListGestures.size(); idx++)
//		{
//			if(count >= 0 && count < 7) {
//				tempListBase.add(tempTemplate.ListGestures.get(idx));
//			}	
//			else {
//				tempListAuth.add(tempTemplate.ListGestures.get(idx));
//			}
//			
//			count++;
//			if(count >= 14) {
...
//		}
//		
//		Template templateBase = new Template();
//		templateBase.ListGestures = tempListBase;
//		
//		Template templateAuth = new Template();
//		templateAuth.ListGestures = tempListAuth;
//		
//		TemplateExtended tBaseExtended = new TemplateExtended(templateBase);
//		TemplateExtended tAuthExtended = new TemplateExtended(templateAuth);
//		
//		TemplateComparer comparer = new TemplateComparer();
//		comparer.CompareTemplates(tBaseExtended, tAuthExtended);
//		
//		boolean result = true;
//		double score = comparer.GetScore();
//		if(score < 0.9) {
