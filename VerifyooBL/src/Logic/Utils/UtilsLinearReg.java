...
public class UtilsLinearReg {
	protected LinearRegression mLinearRegObj = null;

	public void CalcLinearReg(double[] x, double[] y)
	{
		mLinearRegObj = new LinearRegression(x, y);
	}

	public LinearRegression GetLinearRegObj()
	{
		return mLinearRegObj;		
	}
